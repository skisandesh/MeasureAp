...
final largeType36 = GoogleFonts.manrope(
    fontSize: 36, color: black600Color, fontWeight: FontWeight.w700);

final smallType12 = GoogleFonts.manrope(
    fontSize: 12, color: greyColor, fontWeight: FontWeight.w400);

///
final mediumType12 = GoogleFonts.manrope(fontSize: 12, color: greyColor);
final mediumType16 = GoogleFonts.manrope(fontSize: 16, color: greyColor);
final mediumType12Orange =
    GoogleFonts.manrope(fontSize: 12, color: orange700Color);
final mediumType18White = GoogleFonts.manrope(
    fontSize: 18, fontWeight: FontWeight.w700, color: const Color(0XFFFFFFFF));

// semibold
final semiBoldType16 = GoogleFonts.manrope(
    fontSize: 16, fontWeight: FontWeight.w800, color: black600Color);
...
final boldType24 = GoogleFonts.manrope(
    fontSize: 24, fontWeight: FontWeight.w700, color: black600Color);
...
final mediumType14 = GoogleFonts.manrope(fontSize: 14, color: greyColor);
final mediumTypeBlack14 =
    GoogleFonts.manrope(fontSize: 14, color: black600Color);
// colored text
...
final body14Green = GoogleFonts.manrope(
    fontSize: 14, fontWeight: FontWeight.w700, color: correctColor);
final body14Brown = GoogleFonts.manrope(
    fontSize: 14, fontWeight: FontWeight.w700, color: inCorrectColor);
